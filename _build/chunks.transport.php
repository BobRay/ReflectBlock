<?php
/**
 * Utility snippet for ReflectBlock development
 *
...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/reflectblock',
    'source_assets' => $root . 'assets/components/reflectblock',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/reflectblock/docs/',
);
unset($root);
...
$category = $modx->getObject('modCategory', array('category'=>'ReflectBlock'));

if (! $category) {
    $category= $modx->newObject('modCategory');
    $category->set('category','ReflectBlock');
}
