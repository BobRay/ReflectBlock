...
/**
 * ReflectBlock resolver script - runs on install.
 *
 ...
 */
/**
 * Description: Resolver script for ReflectBlock package
 * @package reflectblock
 * @subpackage build
 */
...
$plugins = array('ReflectBlock');

$category = 'ReflectBlock';
...
$logFile = $logDir . 'reflctblock.log';
